    ...
    >
      <div className="mx-auto max-w-7xl grid md:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        >
          ...
          <p className="mt-8 font-serif text-2xl md:text-3xl italic text-[var(--color-cream-foreground)]">
        ...
        <motion.div
          ...
          className="md:col-span-6 order-1 md:order-2 relative group"
        >
          ...
          <div className="absolute -bottom-4 -right-4 hidden md:block h-24 w-24 border-b border-r border-accent" />
        </motion.div>
      </div>
    </section>
  );
